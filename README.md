...
Forward - Reverse - Forward (TIP: Handles for the curve can be adjusted outside the window by editing the value fields).
...
Setting visibility to "Static" keeps the point on screen before and after the animation.
